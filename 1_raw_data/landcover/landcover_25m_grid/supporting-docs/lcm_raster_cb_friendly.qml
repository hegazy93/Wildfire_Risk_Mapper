...
<qgis styleCategories="AllStyleCategories" maxScale="0" minScale="1e+08" hasScaleBasedVisibilityFlag="0" version="3.4.11-Madeira">
  ...
  <pipe>
    <rasterrenderer type="paletted" opacity="1" alphaBand="-1" band="1">
      ...
      <colorPalette>
        <paletteEntry value="1" alpha="255" color="#33a02c" label="Broadleaved woodland"/>
        <paletteEntry value="2" alpha="255" color="#005000" label="Coniferous woodland"/>
        <paletteEntry value="3" alpha="255" color="#f0e442" label="Arable"/>
        <paletteEntry value="4" alpha="255" color="#01ff7c" label="Improved grassland"/>
        <paletteEntry value="5" alpha="255" color="#dc9909" label="Neutral grassland"/>
        <paletteEntry value="6" alpha="255" color="#ffc037" label="Calcareous grassland"/>
        <paletteEntry value="7" alpha="255" color="#b29100" label="Acid grassland"/>
        <paletteEntry value="8" alpha="255" color="#fd7bee" label="Fen, Marsh and Swamp"/>
        ...
        <paletteEntry value="11" alpha="255" color="#cd3bb5" label="Bog"/>
        <paletteEntry value="12" alpha="255" color="#d2d2ff" label="Inland rock"/>
        <paletteEntry value="13" alpha="255" color="#00005c" label="Saltwater"/>
        <paletteEntry value="14" alpha="255" color="#0000ff" label="Freshwater"/>
        <paletteEntry value="15" alpha="255" color="#987db7" label="Supralittoral rock"/>
